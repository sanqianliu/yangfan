    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-inner">
                ...
                <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">暗夜商城 - 后台管理</a>
        ...
        <div id="sidebar-nav">
            <ul id="dashboard-menu">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            ...
                            <a href="<?php echo yii\helpers\Url::to(['manage/reg']);?>">添加新管理员</a></li>
                    </ul>
                </li>
                <li>
                    <a class="dropdown-toggle" href="#">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="/index.php?r=admin%2Fcategory%2Flist">分类列表</a></li>
                        <li>
                            <a href="/index.php?r=admin%2Fcategory%2Fadd">加入分类</a></li>
                    </ul>
                </li>
                <li>
                    <a class="dropdown-toggle" href="#">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="/index.php?r=admin%2Fproduct%2Flist">商品列表</a></li>
                        <li>
                            <a href="/index.php?r=admin%2Fproduct%2Fadd">添加商品</a></li>
                    </ul>
                </li>
                <li>
                    <a class="dropdown-toggle" href="#">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="/index.php?r=admin%2Forder%2Flist">订单列表</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-right">
                                        <a href="<?php echo yii\helpers\Url::to(['manage/delete','adminid' => $manager->adminid ]);?>">删除</a>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                            </tbody>
