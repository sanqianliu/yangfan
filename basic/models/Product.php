...
{
    const AK = 'lAkfJZl58sbM_Cikv6g_1IMUDirUoBgIEp4iHPEU';
    const SK = 'EqkZTbAd5VBOxZnKR0ZXhJbI_l0CgbbyURHQYU1R';
    const DOMAIN = 'ormlsq8vw.bkt.clouddn.com';
    const BUCKET = 'yangfan-shop';
